...
### SAP Business One Partner & Integration Experts
...
[![Location](https://img.shields.io/badge/Wroc%C5%82aw,_Poland-00A3E0?style=for-the-badge&logo=google-maps&logoColor=white)](https://bizcode.pl)
...
|---|---|
| [`bizcode-integration-platform`](https://github.com/BizCode-Sp-z-o-o/bizcode-integration-platform) | Docker Compose deployment with interactive installer |
| [`bizcode-helm-charts`](https://github.com/BizCode-Sp-z-o-o/bizcode-helm-charts) | Helm charts for Kubernetes / Rancher deployments |
...
![SAP HANA](https://img.shields.io/badge/SAP_HANA-1661BE?style=flat-square&logo=sap&logoColor=white)
...
[info@bizcode.pl](mailto:info@bizcode.pl) · [bizcode.pl](https://bizcode.pl)
